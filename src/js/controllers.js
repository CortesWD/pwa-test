(function (_) {
  ...
  angular.module('pokedex.controllers', [])
    .controller('PokedexController', ['$scope', '$routeParams', '$location', 'pokemonService', function ($scope, $routeParams,  $location, pokemonService) {
    ...
    .controller('Poke404', '$scope', '$routeParams', function ($scope, $routeParams) {
      $scope.isOn404 = 404
